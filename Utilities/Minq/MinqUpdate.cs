...
//         return this;
//     }
//     public MinqUpdate<T> Increment(Expression<Func<T, long>> field, long amount = 1)
//     {
//         Updates.Add(Builder.Inc(field, amount));
//         return this;
//     }
//     public MinqUpdate<T> Increment(Expression<Func<T, double>> field, double amount = 1)
//     {
//         Updates.Add(Builder.Inc(field, amount));
//         return this;
//     }
...
//     /// <typeparam name="U"></typeparam>
//     /// <returns></returns>
//     public MinqUpdate<T> AddItems<U>(Expression<Func<T, IEnumerable<U>>> field, int limitToKeep, params U[] item)
//     {
//         if (limitToKeep == 0)
...
//     /// <param name="field"></param>
//     /// <returns></returns>
//     public MinqUpdate<T> SetToCurrentTimestamp(Expression<Func<T, long>> field)
//     {
