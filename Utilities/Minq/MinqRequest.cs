...
//     ).AsBsonDocument.ToString();
//     
//     public MinqRequest(Minq<T> parent, FilterDefinition<T> filter = null)
//     {
//         _filter = filter ?? Builders<T>.Filter.Empty;
//         Parent = parent;
//     }
//     
//     public MinqRequest<T> OnTransactionEnded(Action action)
//     {
//         if (action != null)
...
//     }
//
//     public MinqRequest<T> OnRecordsAffected(Action<RecordsAffectedArgs> result)
//     {
//         if (result != null)
...
//     }
//
//     public MinqRequest<T> OnNoneAffected(Action<RecordsAffectedArgs> result)
//     {
//         if (result != null)
...
//     }
//
//     public MinqRequest<T> Limit([Range(0, int.MaxValue)] int limit)
//     {
//         _limit = limit;
//         return this;
//     }
...
//     {
//         if (Consumed)
//             throw new PlatformException("The MinqRequest was previously consumed by another action.  This is not allowed to prevent accidental DB spam.");
//         Consumed = true;
//     }
//     
...
//     }
//     
//     public long Update(Action<MinqUpdate<T>> query)
//     {
//         EnforceNotConsumed();
//
